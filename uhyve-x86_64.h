...
#define GDT_GET_BASE(x)                                                    \
	((((x)&0xFF00000000000000) >> 32) | (((x)&0x000000FF00000000) >> 16) | \
	 (((x)&0x00000000FFFF0000) >> 16))

#define GDT_GET_LIMIT(x) \
	(__u32)((((x)&0x000F000000000000) >> 32) | (((x)&0x000000000000FFFF)))
...
#define GDT_ENTRY(flags, base, limit)                \
	((((base)&_AC(0xff000000, ULL)) << (56 - 24)) |  \
	 ...
	 (((base)&_AC(0x00ffffff, ULL)) << 16) | (((limit)&_AC(0x0000ffff, ULL))))
